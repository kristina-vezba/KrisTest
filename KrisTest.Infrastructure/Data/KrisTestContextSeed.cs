...
namespace KrisTest.Infrastructure.Data
{
	public static class KrisTestContextSeed
	{
		public static void Seed(IApplicationBuilder applicationBuilder)
		{
			...
			Order o1 = new Order { Id = 1, Number = "1. order", ShipToAddress = "Ostavi kod komsije", Account = a1 };
			Order o2 = new Order { Id = 2, Number = "2. order", Account = a1 };
			...
			WebUser wu2 = new WebUser
				{ Id = 1, Name = "UserTwo", Password = "JopetPassword", State = Domain.Enums.UserState.Active };

			context.WebUsers.AddRange(wu1);

			ShoppingCart sc1 = new ShoppingCart
				{ Id = 1, WebUser = wu1, Account = a1, Created = new DateTime(2000 - 02 - 02) };

			ShoppingCart sc2 = new ShoppingCart
				{ Id = 2, WebUser = wu2, Account = a3, Created = new DateTime(2012 - 08 - 21) };

			context.ShoppingCarts.AddRange(sc1, sc2);

			LineItem li1 = new LineItem
				{ Id = 1, Quantity = 5, Price = 49.95, Product = p1, Order = o1, ShoppingCart = sc1 };

			LineItem li2 = new LineItem
				{ Id = 2, Quantity = 10, Price = 3.95, Product = p2, Order = o1, ShoppingCart = sc2 };

			LineItem li3 = new LineItem
				{ Id = 3, Quantity = 150, Price = 0.95, Product = p3, Order = o2, ShoppingCart = sc1 };

			LineItem li4 = new LineItem
				{ Id = 4, Quantity = 6, Price = 9.95, Product = p4, Order = o2, ShoppingCart = sc2 };

			LineItem li5 = new LineItem
				{ Id = 5, Quantity = 5, Price = 19.95, Product = p5, Order = o2, ShoppingCart = sc1 };
			...
			Payment pay1 = new Payment
				{ Id = 1, Paid = DateTime.Today, Total = 100.00, Details = "neke sitnice", Account = a1 };
